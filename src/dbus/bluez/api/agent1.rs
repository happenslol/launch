...
#[proxy(interface = "org.bluez.Agent1", default_service = "org.bluez")]
pub trait Agent1 {
  ...
  ///
  fn request_pin_code(&self, device: &zbus::zvariant::ObjectPath<'_>) -> zbus::Result<String>;
  ...
  /// :org.bluez.Error.Canceled:
  ///
  fn request_passkey(&self, device: &zbus::zvariant::ObjectPath<'_>) -> zbus::Result<u32>;
  ...
  /// :org.bluez.Error.Canceled:
  ///
  fn request_authorization(&self, device: &zbus::zvariant::ObjectPath<'_>) -> zbus::Result<()>;
