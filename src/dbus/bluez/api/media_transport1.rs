...
pub trait MediaTransport1 {
  ...
  ///
  fn acquire(&self) -> zbus::Result<(std::os::fd::RawFd, u16, u16)>;
  ...
  /// :org.bluez.Error.NotAvailable:
  ///
  fn try_acquire(&self) -> zbus::Result<(std::os::fd::RawFd, u16, u16)>;
  ...
  #[zbus(property)]
  fn set_delay(&self, value: u16) -> zbus::Result<()>;
  ...
  ///
  #[zbus(property)]
  fn endpoint(&self) -> zbus::Result<zbus::zvariant::OwnedObjectPath>;

  /// Indicates transport Audio Location.
  ///
  #[zbus(property)]
  fn location(&self) -> zbus::Result<u32>;
