...
#[proxy(interface = "org.bluez.MediaEndpoint1", default_service = "org.bluez")]
pub trait MediaEndpoint1 {
  ...
  fn set_configuration(
    &self,
    transport: &zbus::zvariant::ObjectPath<'_>,
  ...
  ///
  fn select_configuration(&self, capabilities: &[u8]) -> zbus::Result<Vec<u8>>;
  ...
  fn select_properties(
    &self,
    capabilities: &std::collections::HashMap<&str, &zbus::zvariant::Value<'_>>,
  ...
  ///
  fn clear_configuration(&self, transport: &zbus::zvariant::ObjectPath<'_>) -> zbus::Result<()>;
  ...
  ///
  #[zbus(property)]
  fn vendor(&self) -> zbus::Result<u32>;
  ...
  ///
  #[zbus(property)]
  fn locations(&self) -> zbus::Result<u32>;

  /// Indicates endpoint supported audio context.
  ///
  #[zbus(property)]
  fn supported_context(&self) -> zbus::Result<u16>;

  /// Indicates endpoint available audio context.
  ///
  #[zbus(property)]
  fn context(&self) -> zbus::Result<u16>;
